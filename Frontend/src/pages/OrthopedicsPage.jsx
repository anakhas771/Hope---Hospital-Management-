...
const OrthopedicsPage = () => {
  ...
  const departmentName = "Orthopedics";
    ...
    <PageSection>
      ...
      >
        ...
        <p className="text-gray-200 max-w-3xl mx-auto">
          Comprehensive orthopedic care for bones, joints, and muscles. Expertise in surgeries, rehabilitation, and sports injury management.
        </p>
